function build_matrixmult(debug)
%BUILD_MATRIXMULT
%   Compile matrix_mult.f90 and its MEX gateway matrix_gateway.c.
%
%   Call this once before using matrix_gateway.
%   The input 'debug' set to true prints progress.
%
%   Recompiles only when matrix_mult.f90 or matrix_gateway.c is newer
%   than the last build (see needsRebuild.m).
%
...
%
    ...
    fortranFile = 'matrix_mult.f90';
    gatewayFile = 'matrix_gateway.c';
    [libExt, rpathFlag] = libPlatformInfo();
    libFile = ['libmatrixmult.' libExt];
    ...
    say('Building matrixmult MEX Gateway\n\n');
    ...
    say('Linking %s...\n', libFile);
    linkCmd = [gf, ' -shared -o ', libFile, ' matrix_mult.o ', rpathFlag];
